...
2. Explicite requisitos funcionais e não funcionais, hipóteses e restrições.
3. Separe claramente componentes Microsoft, operadora, rede, identidade, dados, integrações e customizações.
4. Avalie no mínimo:
...
5. Compare alternativas em critérios objetivos e escolha uma recomendação.
6. Acione **MDCC Validator** antes da conclusão.
